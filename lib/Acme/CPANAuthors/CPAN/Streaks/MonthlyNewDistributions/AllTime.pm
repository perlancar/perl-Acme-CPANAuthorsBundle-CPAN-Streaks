...
#IPC::System::Options::system({die=>1, capture_stdout => \$main::stdout}, "cpan-streaks", "calculate", "monthly-new-distributions", "--include-broken", "--min-len", 6, "--format", "text-pretty");
#$main::stdout =~ s/^/  /gm;
